                                                                ...
                                                                <form class="form-horizontal form-label-left" novalidate>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="col-md-6 col-md-offset-3">
                                                                            <button id="send1" type="submit" class="btn btn-success">Add New</button>
                                                                        </div>
                                                                    </div>
                                                                </form>
                                                            </div>
...
//rec = new User();
                                ...
                                if($query) {
                                    ...
                                    while ($row = $query->fetch_object()) {
                                            ...
                                            $i++;
                                            echo ' <tr id="dataInfo"><td> <p>' . $i . '</p></td><td><p> ' . $row->subcategory_name . '</p></td><td><p>' . $row->art_number . '</p></td>  <td>
                     ...
                     <!-- <a href=\"deleteMusic.php?id=' . $row->id . ' class=\"btn btn-danger btn-xs\"><button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#myModal"><i class=\"fa fa-pencil\"></i>Edit</button> </a>-->
                    </td> </tr>';
                        ...
                        if(isset($_GET['submit'])) {
                            ...
                            echo $subcategory_name."And".$subcategory_id;
                            ...
                            if (!empty($subcategory_name)&&!empty($subcategory_id)) {
                                ...
                                if ($query) {
                                    echo "<script>alert('It was edited successfully')</script>";
                                } else {
                                    echo "<script>alert('It failed')</script>\"";
                                }
                            }
